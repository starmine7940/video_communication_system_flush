...
(async function main() {
    ...
    function flush(personalVideoContainer){
        personalVideoContainer.classList.add('highlight');
        setTimeout(function() {
            personalVideoContainer.classList.remove('highlight');
        }, 500);
    }
})();